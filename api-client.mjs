 ...
 * @property {boolean} [verbose] - Enable verbose debug logging
 * @property {Object} [headers] - Default headers to send with every request
 * @property {number} [delay] - Fake network delay in milliseconds
 * @property {Object} [authProvider] - Auth provider object
 * @property {function(Response): boolean} [success] - Success function to check response status
 */

/**
 * @typedef {Object} AuthProvider
 * @property {function(): string} getAccessToken - Function to get an access token
 */
...
export class APIClient {
   ...
   * @param {string} endpoint - The base URL of the API
